/////
 // PDFManager.js
 // This is the managing module for the JS PDF compression application.
 // Taken and modified from: https://github.com/OpenToolKit/CompressPDF
 // GNU GPL v3.0 https://github.com/OpenToolKit/CompressPDF/blob/master/LICENSE
 ///
...
var sorted = false;
var input_scale = 1;
var input_quality = 0.1; // 10% compression
//var input_quality_ui = 0.5;
...
//var pageQualityUI = input_quality_ui;
...
///////////////////////////////////////////// INITIALIZE ///////////////////////////////////////////
// compression entrance
function compress(fileBytes, fileName, fileDate) {
    if (fileBytes) {
        input_file_name = fileName;
        fetch(fileBytes) // create blob... but is it already formatted?
            .then(response => response.blob())
            .then((data) => {
                if (data) {
                    input_file = new File(data, fileName, {
                        type: "application/pdf", lastModified: fileDate
                    });
                    // add to files object
                    fc = 1;
                    generateMetadata(input_file);
                }
            });
    } else {
        return;
    ...
    return ""; // TODO: return compressed string
}
